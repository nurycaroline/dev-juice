...
export class QrReaderProvider {
    ...
    public static createOrShow(extensionUri: vscode.Uri): void {
        ...
        panel.webview.html = QrReaderProvider.getWebviewContent();
        ...
        <body>
            <div class="container">
                ...
                <div class="section">
                    ...
                    <div class="info">
                        <strong>ℹ️ Como usar:</strong> Selecione ou arraste uma imagem contendo um QR Code. O leitor irá automaticamente detectar e decodificar o conteúdo do código.
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div id="resultArea" class="result-area">
                        ...
                        <div class="button-group">
                            <button class="secondary-btn" onclick="copyResult()">Copiar Texto</button>
                ...
                <div class="info">
                    <strong>💡 Dica:</strong> QR Codes podem conter URLs, texto, informações de contato, dados Wi-Fi, e muito mais. Este leitor suporta todos os tipos de QR Codes padrão.
                </div>
            </div>
            ...
            <script>
                ...
                function decodeQRCode(img, imageSrc) {
                    try {
                        ...
                        if (code) {
                            showResult(code.data, imageSrc, true);
                        } else {
                            showResult('', imageSrc, false);
                        }
                    } catch (error) {
                        hideLoading();
                ...
                function showResult(text, imageSrc, success) {
                    ...
                    // Show image preview
                    imagePreview.innerHTML = '<img src="' + imageSrc + '" class="image-preview" alt="QR Code Image">';
