...
export class UrlEncoderProvider {
    ...
    public static createOrShow(extensionUri: vscode.Uri): void {
        ...
        UrlEncoderProvider.currentPanel = panel;

        // Set the webview's initial html content
        panel.webview.html = UrlEncoderProvider.getWebviewContent();
    ...
    private static getWebviewContent(): string {
        ...
        <body>
            <div class="container">
                ...
                <div class="info">
                    <strong>ℹ️ Informação:</strong> O URL encoding (codificação de URL) é usado para converter caracteres especiais em um formato seguro para transmissão em URLs. Caracteres como espaços, acentos e símbolos são convertidos em códigos percentuais.
                </div>

                <div class="warning">
                    <strong>⚠️ Nota:</strong> Alguns caracteres como números e letras básicas não são alterados durante a codificação, pois já são seguros para URLs.
                </div>
            </div>
